...
void renderCornellboxA(float scale, const char* filename)
{
  ...
  scene->add(new Quad(Point(000.f, 000.f, 560.f) * scale,
    ...
    nullptr, mat));  //back wall
  scene->add(new Quad(Point(000.f, 000.f, 000.f) * scale,
    Vector(000.f, 000.f, 560.f) * scale, Vector(000.f, 550.f, 000.f) * scale,
    nullptr, mat));  //right wall
  scene->add(new Quad(Point(550.f, 550.f, 000.f) * scale,
    Vector(000.f, 000.f, 560.f) * scale, Vector(000.f, -550.f, 000.f) * scale,
    nullptr, mat));  //left wall

  //short box
  makeBox(scene, Point(082.f, 000.1f, 225.f) * scale,
    Vector(158.f, 000.f, 047.f) * scale, Vector(048.f, 000.f, -160.f) * scale,
    Vector(000.f, 165.f, 000.f) * scale, nullptr, mat);

  //tall box
  makeBox(scene, Point(265.f, 000.1f, 296.f) * scale,
    Vector(158.f, 000.f, -049.f) * scale, Vector(049.f, 000.f, 160.f) * scale,
    Vector(000.f, 330.f, 000.f) * scale, nullptr, mat);

  //point light
  world.light.push_back(
    new PointLight(Point(288 * scale, 529.99f * scale, 279.5f * scale),
      RGBColor::rep(40000.0f * scale * scale)));
  world.light.push_back(
    new PointLight(Point(490 * scale, 329.99f * scale, 279.5f * scale),
      RGBColor(60000.0f * scale * scale, 0, 0)));
  world.light.push_back(
    new PointLight(Point(40 * scale, 329.99f * scale, 279.5f * scale),
      RGBColor(0, 60000.0f * scale * scale, 0)));
...
void renderCornellboxB(float scale, const char* filename)
{
  ...
  scene->add(new Quad(Point(000.f, 000.f, 000.f) * scale,
    Vector(550.f, 000.f, 000.f) * scale, Vector(000.f, 000.f, 560.f) * scale,
    nullptr, mat));  //floor
  scene->add(new Quad(Point(000.f, 550.f, 000.f) * scale,
    Vector(550.f, 000.f, 000.f) * scale, Vector(000.f, 000.f, 560.f) * scale,
    nullptr, mat));  //ceiling
  scene->add(new Quad(Point(000.f, 000.f, 560.f) * scale,
    Vector(550.f, 000.f, 000.f) * scale, Vector(000.f, 550.f, 000.f) * scale,
  ...
  scene->add(new Quad(Point(000.f, 000.f, 000.f) * scale,
    Vector(000.f, 000.f, 560.f) * scale, Vector(000.f, 550.f, 000.f) * scale,
    nullptr, mat));  //right wall
  scene->add(new Quad(Point(550.f, 000.f, 000.f) * scale,
    Vector(000.f, 000.f, 560.f) * scale, Vector(000.f, 550.f, 000.f) * scale,
    nullptr, mat));  //left wall
  ...
  world.light.push_back(
    new PointLight(Point(288 * scale, 529.99f * scale, 279.5f * scale),
      RGBColor::rep(20000.0f * scale * scale)));

  //spot light
  world.light.push_back(
    new SpotLight(Point(70.f, 400.f, 230.f) * scale, Vector(0.0f, -1.0f, 0.0f),
      pi / 4, 8.0f, RGBColor(0, 60000.0f * scale * scale, 0)));
  world.light.push_back(new SpotLight(Point(520.f, 300.f, 230.f) * scale,
    Vector(-1.0f, -1.0f, 0.0f), pi / 3, 3.0f,
    RGBColor(60000.0f * scale * scale, 0, 0)));

  //directional light
  DirectionalLight dirl(
    Vector(0.2f, -0.5f, 0.5f).normalize(), RGBColor(0.25f, 0.25f, 0.5f));
...
void renderCornellboxC(float scale, const char* filename)
{
  ...
  makeBox(scene, Point(082.f, 000.1f, 225.f) * scale,
    Vector(
            158.f, 000.f, 047.f) * scale, Vector(048.f, 000.f, -160.f) * scale,
    Vector(000.f, 165.f, 000.f) * scale, nullptr, mat);
  ...
  //point light
  world.light.push_back(new ProjectiveLight(
    Point(288 * scale, 529.99f * scale, 279.5f * scale), 0.8f, 0.8f));
  ...
  //directional light
  DirectionalLight dirl(
    Vector(0.2f, -0.5f, 0.5f).normalize(), RGBColor(1.f, 1.f, 1.f));
  world.light.push_back(&dirl);
